...
// const eachtalentId = 0; // Replace 0 with the actual talentId of the clicked element
// localStorage.setItem('selectedTalentId', eachtalentId.toString());
...
//     switch (lokerType) {
//         case "Admin":
//             window.location.href = "Admin-Detail-Page.html";
//             break;
//         case "Photography":
//             window.location.href = "Photography-loker.html";
//             break;
...
// // const bodyDetail = document.querySelector('.body-left-right')

// // function displayByID(talentID) {
// //     const selectedID = document.createElement("div")
// //     selectedID.classList.add('body-left-right');
// //     console.log("hello")
// //     console.log(talentID)
    
// //     detailLoker.forEach((desc) => {
// //         if (talentID === desc.id) {
            
// //             console.log(desc.id)
// //             desc.content.forEach(item => {
// //                 const currimg = item.Image;
...
// //               });
// //             }
// //             bodyDetail.appendChild(selectedID);
// //     })
// // }
